<?php
	...
	echo $btn_url="<a class='page_btn_class' href='?current_pg_no=1".$and.$url_keys."&search_btn'>First Page</a>";
	 if($loop_count>1 && $_GET['current_pg_no']!=$loop_count){
	  ...
	  $limit_calculation=($per_page_in_sql*$current_pg_no_in_sql).",".$per_page_in_sql;
	    ...
	    return $returnarr2=array('pages'=>$returnarr,'fetch_data'=>$fetch_data,'sql'=>$sql2,'keys'=>$btn_url);
	}
